...
const Smartcontract = () => {
  return (
    <div className="max-w-[1280px] 2xl:max-w-[1599px] w-full mx-auto flex flex-col gap-[72px] pt-[50px] sm:pt-[70px] md:pt-[90px] xl:pt-[100px] 2xl:pt-[139px] pb-[50px] sm:pb-[70px] md:pb-[100px] xl:pb-[120px] 2xl:pb-[171px] px-3">
